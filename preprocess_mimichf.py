...
data=pd.read_csv('.//mort48_inthour_iv_hf.csv',index_col='hadm_id')
...
for p in pbar:
    ...
    if len(temp.shape)==2:
        ...
        temp.to_csv('.//mortality48_hour_iv_hf//'+str(p)+'.csv')
...
data_sta.to_csv('.//mortality48_hour_iv_hf//data_info//data_info.csv')
...
train.to_csv('.//mortality48_hour_iv_hf//data_info//train.csv')
test.to_csv('.//mortality48_hour_iv_hf//data_info//test.csv')
...
for i in range(fold_num-1):
    ...
    fold.to_csv('.//mortality48_hour_iv_hf//data_info//fold'+str(i)+'_info.csv')
    folds.append(fold)
...
fold.to_csv('.//mortality48_hour_iv_hf//data_info//fold'+str(fold_num-1)+'_info.csv')
folds.append(fold)
...
folds_info.to_csv('.//mortality48_hour_iv_hf//data_info//folds_info.csv')
